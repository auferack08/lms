...
def _do_create_account(post_vars, extended_profile=None):
    ...
    profile.major_name = post_vars.get('major_name')
    profile.school_name = post_vars.get('school_name')
    profile.admission_time = post_vars.get('admission_time')
    profile.class_name = post_vars.get('class_name')
